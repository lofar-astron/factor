...
class ChgCentre(Action):
    """
    Action to run chgcentre
    ...
    ----------------
    output_datamap : Datamap
        Map of output vis files with new center
    ...
    def __init__(self, op_parset, input_datamap, p, prefix=None,
        ...
        """
        super(ChgCentre, self).__init__(op_parset, name='ChgCentre', prefix=prefix,
            direction=direction, band=band, index=index)
