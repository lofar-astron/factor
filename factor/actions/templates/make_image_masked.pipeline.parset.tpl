...
casapy1.parsetarg.clean.mask=['{{ input_mask }}']
...
casapy2.control.opts.mapfile_in={{ vis_datamap_image1 }}
...
casapy2.control.opts.arguments=[--nologger,--log2term,--nogui,-c]
casapy2.control.opts.max_per_node=1
...
casapy2.parsetarg.clean.mask=['{{ input_mask }}', '{{ bdsm_mask }}']
