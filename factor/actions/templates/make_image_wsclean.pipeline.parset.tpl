...
wsclean.control.opts.arguments=[-name, imagename, -size, {{ imsize }}, {{ imsize }}, -niter, {{ niter }}, -threshold, {{ threshold_jy }}, -pol, I, -weight, briggs, -0.25, -scale, {{ cell_deg }}, -joinchannels, -channelsout, {{ nchannels }}, -mgain, {{ 0.8 }}, -j, {{ ncpu }}, {{wsclean_multiscale}} {{mask}} msin]
