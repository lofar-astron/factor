...
wsclean.control.opts.arguments=[-name, imagename, -size, {{ imsize }}, {{ imsize }}, -niter, {{ niter }}, -threshold, {{ threshold_jy }}, -pol, xx, -weight, briggs, -0.25, -scale, {{ cell_deg }}, -joinchannels, -channelsout, 4, -mgain, {{ 0.8 }}, msin]
