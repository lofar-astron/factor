...
fft.control.opts.arguments=[-predict, -name, imagename, -smallinversion, -size, {{ imsize }}, {{ imsize }}, -scale, {{ cell_deg }}, -channelsout, {{ nchannels }}, -j, {{ ncpu }}, -nwlayers, {{ wplanes }}, inputms]
